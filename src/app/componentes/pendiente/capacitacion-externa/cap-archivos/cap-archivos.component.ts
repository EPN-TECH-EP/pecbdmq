...
@Component({
  selector: 'app-cap-archivos',
  templateUrl: './cap-archivos.component.html',
  styleUrls: ['./cap-archivos.component.scss']
})
export class CapArchivosComponent implements OnInit {
