...
export class UsuarioService {
  ...
  public resetPassword(nombreUsuario: string): Observable<CustomHttpResponse> {
    return this.http.get<CustomHttpResponse>(`${this.host}/usuario/resetPassword/${nombreUsuario}`);
  }
